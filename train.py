...
if __name__ == '__main__':
    ...
    config.to_json_file('/content/BERT-keyphrase-extraction/model/config.json')
    model = BertForTokenClassification.from_pretrained('./model/pytorch_model.bin', config=config)
    config = model.config
    config.to_json_file('bert_config1.json')
    ...
    torch.save(model.state_dict(), '/content/BERT-keyphrase-extraction/model/model.pth')
